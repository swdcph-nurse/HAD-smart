...
import { Download, FilePlus2, Pencil, Plus, Printer, QrCode, Search, ShieldCheck, X } from 'lucide-react'
...
function CardSection({ title, text }: { title: string; text: string | null }) { return <section className="rounded-xl bg-accent-soft/60 p-3"><h4 className="text-sm font-semibold text-accent">{title}</h4><p className="mt-1 whitespace-pre-wrap text-xs leading-5 text-ink">{text || '-'}</p></section> }
